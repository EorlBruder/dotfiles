...
% Hook for overriding the header
\ifcsname themeHeaderHook\endcsname
  \fancypagestyle{customHeader}{
    % Offset the top of the page because of the image
    \setlength\headheight{3.3cm}
    \addtolength{\textheight}{-3.3cm}
    \fancyhead{\themeHeaderHook}
    \renewcommand{\headrulewidth}{0cm}
  }
...
% Last hook
\ifcsname themeFinalHook\endcsname
  \themeFinalHook
\fi
